(function (factory) {
    ...
    Markdown.prototype = {
        constructor: Markdown, __alterButtons: function (name, alter) {
            ...
            for (i = 0; i < buttonsArray.length; i++) {
                ...
                for (y = 0; y < btnGroups.length; y++) {
                    ...
                    for (z = 0; z < buttons.length; z++) {
                        var button = buttons[z], buttonContainer, buttonIconContainer,
            ...
            var target = $(e.currentTarget), handler = this.$handler, callback = this.$callback,
            ...
            var instance = this, textarea, ns = this.$ns, container = this.$element,
                originalHeigth = container.css("height"), originalWidth = container.css("width"),
                editable = this.$editable, handler = this.$handler, callback = this.$callback,
                options = this.$options, editor = $("<div/>", {
            ...
            if (this.$editor === null) {
                ...
                var editorFooter = $("<div/>", {"class": "md-footer"}), createFooter = false,
                    footer = "";
                if (options.savable) {
                    createFooter = true;
            ...
            var options = this.$options, container = this.$textarea,
                afterContainer = container.next(), replacementContainer = $("<div/>", {
                    "class": "md-preview",
            ...
            if (editor.hasClass("active") || this.$element.parent().length === 0) {
                ...
                if (isHideable) {
                    if (editable.el !== null) {
                        var oldElement = $("<" + editable.type + "/>"), content = this.getContent(),
    ...
    $.fn.markdown = function (option) {
        return this.each(function () {
            var $this = $(this), data = $this.data("markdown"),
    ...
    var blurNonFocused = function (e) {
        ...
        $(document).find(".md-editor").each(function () {
            var $this = $(this), focused = $activeElement.closest(".md-editor")[0] === this,
